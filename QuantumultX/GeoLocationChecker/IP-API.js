...
var subtitle = City_ValidCheck(obj['city']) + ' ✪ '+ MISC_ValidCheck(obj['continentCode']) + '·'+ MISC_ValidCheck(obj['countryCode']) + '·'+ MISC_ValidCheck(obj['region']) + '·'+ MISC_ValidCheck(obj['zip']);
var ip = obj['query'];
